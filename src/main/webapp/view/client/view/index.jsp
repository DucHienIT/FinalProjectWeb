...
<div class="wrapper">
			...
			<ul>
				...
				<li class="revolution-mch-1" data-transition="fade"
					...
					<div class="tp-caption revolution-ch4 sft" data-x="center"
						...
						data-start="2000" data-easing="Power4.easeOut" data-endspeed="300"
						data-endeasing="Power1.easeIn" data-captionhidden="off"
						style="z-index: 6"></div> <!-- LAYER -->
					<div class="tp-caption sft" data-x="center" data-hoffset="0"
				...
				<li class="revolution-mch-1" data-transition="fade"
					...
					<!-- MAIN IMAGE --> <img src="${url}/img/monitor.jpg"
				...
				<li class="revolution-mch-1" data-transition="fade"
					...
					<!-- MAIN IMAGE --> <img src="${url}/img/background.jpg"
					...
					<li class="item">
						<div class="product-img" style="text-align: center;">
							<a
								...
								width="150" height="150" src="${imgUrl }" alt=""></a> <a
								class="add-to-cart"
	...
	<div class="container content">
		...
		<ul class="list-inline owl-slider-v2">
			...
			<li class="item"><img src="${url}/img/intel.png" alt=""></li>
			<li class="item"><img src="${url}/img/AMD.png" alt=""></li>
			<li class="item"><img src="${url}/img/acer.png" alt=""></li>
			<li class="item"><img src="${url}/img/asus.png" alt=""></li>
			<li class="item"><img src="${url}/img/logitech.png" alt="">
			</li>
			<li class="item"><img src="${url}/img/intel.png" alt=""></li>
			<li class="item"><img src="${url}/img/AMD.png" alt=""></li>
